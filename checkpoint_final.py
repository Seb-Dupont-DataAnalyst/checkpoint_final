...
if choice == 'Zoom':
    ...
    if sub_choice == 'Cépages' :
        ...
        fig.add_annotation(x=3.5, y=df_hors_Pinot['price'].median(), yref="y2",text=df_hors_Pinot['price'].median(),showarrow=False, font=dict(color="black", size=14))
        fig.add_annotation(x=1.25, y=df_hors_Pinot['points'].median(), yref="y",text=df_hors_Pinot['points'].median(),showarrow=False, font=dict(color="black", size=14))
