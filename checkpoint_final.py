...
if choice == 'Analyse du marché':
    ...
    fig.add_annotation(x=1.2, y=df['price'].median(), yref="y2",text=df['price'].median(),showarrow=False, font=dict(color="black", size=14))
    fig.add_annotation(x=-0.3, y=df['points'].median(), yref="y",text=df['points'].median(),showarrow=False, font=dict(color="black", size=14))
