...
if choice == 'Analyse du marché':
    ...
    fig.add_annotation(x=1.17, y=df['price'].median(), yref="y2",text=df['price'].median(),showarrow=False, font=dict(color="white", size=14, weight = bold))
    fig.add_annotation(x=-0.17, y=df['points'].median(), yref="y",text=df['points'].median(),showarrow=False, font=dict(color="white", size=14, weight = bold))
