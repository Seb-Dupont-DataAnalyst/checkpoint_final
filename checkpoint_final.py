...
if choice == 'Zoom':
    ...
    if sub_choice == 'Cépages' :
        ...
        fig3.update_traces(textposition='inside')
        fig3.update_traces(texttemplate="%{label} <br>%{percent:%f}")
        fig3.update_layout(title='<b>Répartition du ' + choix_cepage + ' par pays</b>',
                       title_x=0.5, title_font_family="Verdana", showlegend=False)
...
st.sidebar.title('')
st.sidebar.info('Ckeckpoint n°4 de la formation Data Analyst au sein de la Wild Code School - 06/07/2021')
