...
if choice == 'Zoom':
    ...
    if sub_choice == 'Cépages' :
        ...
        fig.add_annotation(x=2, y=df_cepage['price'].median(), yref="y2",text=df_cepage['price'].median(),showarrow=False, font=dict(color="black", size=14))
        fig.add_annotation(x=-0.2, y=df_cepage['points'].median(), yref="y",text=df_cepage['points'].median(),showarrow=False, font=dict(color="black", size=14))
