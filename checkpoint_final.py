...
st.sidebar.title("Bonjour :wine_glass: :grapes:")
...
choice = st.sidebar.radio(
    "", ('Présentation', 'Analyse du marché', "Zoom", "Descriptions", 'Machine Learning'))
...
if choice == 'Présentation':
    ...
    components.html("<p style='color:black;font-family:verdana; font-size:20px; text-align: center'><i>Bienvenue sur cette page, nous allons voir ensemble une analyse détaillée du marché des vins. Dans une seconde partie nous aborderons ensemble une proposition de pricing.</i></p>")
